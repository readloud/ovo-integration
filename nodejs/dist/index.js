...
class OVOID {
  ...
  login2FA(mobilePhone, deviceId) {
    ...
    return ovoAuth.post('v3/user/accounts/otp', data, this.headers).then(data => {
      var _data$data, _data$data$otp;
      return {
        otp_refId: data === null || data === void 0 ? void 0 : (_data$data = data.data) === null || _data$data === void 0 ? void 0 : (_data$data$otp = _data$data.otp) === null || _data$data$otp === void 0 ? void 0 : _data$data$otp.otp_ref_id,
        device_id: device_id
      };
    });
  }
  login2FAVerify(refId, verificationCode, mobilePhone, device_id) {
    ...
    return ovoAuth.post('v3/user/accounts/otp/validation', data, this.headers).then(data => {
      var _data$data2;
      return data === null || data === void 0 ? void 0 : (_data$data2 = data.data) === null || _data$data2 === void 0 ? void 0 : _data$data2.otp;
    });
  }
  async loginSecurityCode(securityCode, otp_token, mobilePhone, otpRefId, device_id, pushId = 'XXXXXXXXXX') {
    ...
    return ovoAuth.post('v3/user/accounts/login', data, this.headers).then(data => {
      var _data$data3;
      return data === null || data === void 0 ? void 0 : (_data$data3 = data.data) === null || _data$data3 === void 0 ? void 0 : _data$data3.auth;
    });
  }
  getProfile() {
  ...
  getWalletTransaction(page, limit = 10) {
    return ovo.get('wallet/v2/transaction', {
      page,
      limit,
      productType: '001'
  ...
  getBillers() {
    return ovoAws.get('gpdm/ovo/ID/v2/billpay/get-billers', {
      categoryID: '5C6'
    }, this._aditionalHeader());
  }
  ...
  _generateTrxId(amount, actionMark) {
    ...
    return ovo.post('v1.0/api/auth/customer/genTrxId', data, this._aditionalHeader()).then(({
      trxId
    }) => trxId);
  }
}
